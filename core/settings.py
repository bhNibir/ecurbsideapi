...
'https://ecurbside.web.app',
'https://ecrubside.web.app',
]
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgres://ecurbsideapi:k1QUOJ4nAsyqDn9@ecurbsideapi-db.flycast:5432/ecurbsideapi?sslmode=disable',
    )
}
